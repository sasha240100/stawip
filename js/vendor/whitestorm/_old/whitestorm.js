...
WHS.Plane = function(_WHS$Shape11) {
    ...
    function Plane() {
        ...
        _this13.mesh = new mesh(new THREE.PlaneGeometry(params.geometry.width, params.geometry.height, params.geometry.segments, params.geometry.hsegments), _get(Object.getPrototypeOf(Plane.prototype), '_initMaterial', _this13).call(_this13, params.material));
